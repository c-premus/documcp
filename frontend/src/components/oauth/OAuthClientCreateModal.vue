          ...
          <form @submit.prevent="handleSubmit">
            <div class="space-y-4">
              ...
              <div>
                ...
                <button
                  type="button"
                  class="mt-2 inline-flex items-center gap-1 text-sm text-indigo-600 hover:text-indigo-500"
              ...
              <!-- Scope -->
              <div>
                <label for="client-scope" class="block text-sm font-medium text-gray-700">
                  Scope
                </label>
                <input
                  id="client-scope"
