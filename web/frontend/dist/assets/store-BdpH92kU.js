import{E as e}from"./runtime-core.esm-bundler-y1Sx3e_r.js";import{Dn as t,En as n,Mn as r,Nn as i,On as a,Qt as o,Sn as s,bn as c,en as l,hn as u,it as d,jn as f,kn as p,pn as m,vn as h,wn as g,yn as _}from"./dist-CQ2ZHKjt.js";import{i as ee,r as te}from"./browser-JyujKM2J.js";var v=e=>e!=null,ne={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&apos;`};function y(e){return e.replace(/[&<>"']/g,e=>ne[e]??e)}function re(e,t={}){let{indent:n=`  `,format:r=!0,xmlDeclaration:i=!0}=t,a=(e,t,r)=>{let i=``;if(Array.isArray(e))for(let n=0,o=e.length;n<o;n++)i+=a(e[n],t,r);else if(typeof e==`object`&&e){let o=!1,s=``,c=``;for(let t in e)t.charAt(0)===`@`&&(s+=` `+t.substr(1)+`="`+y(e[t].toString())+`"`);for(let t in e)if(t===`#text`)c+=y(e[t]?.toString()??``);else if(t===`#cdata`){let n=e[t]?.toString()??``;c+=`<![CDATA[`+n.replace(/]]>/g,`]]]]><![CDATA[>`)+`]]>`}else t.charAt(0)!==`@`&&(o=!0,c+=a(e[t],t,r+n));o||c?(i+=r+`<`+t+s+`>
`,i+=c,i+=r+`</`+t+`>
`):i+=r+`<`+t+s+`/>
